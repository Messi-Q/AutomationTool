...
node_list_example = ['NULL', 'VAR1', 'VAR2', 'VAR3', 'VAR4', 'VAR5', 'S', 'S1', 'S2', 'S3', 'S4', 'S5', 'W', 'W1', 'W2',
...
def printResult(file, node_feature, edge_feature):
    ...
    nodeOutPath = "../SmartContractDataSet/graph_data_by_automatic_tool/node/" + file
    edgeOutPath = "../SmartContractDataSet/graph_data_by_automatic_tool/edge/" + file
...
if __name__ == "__main__":
    # test_contract = "../SmartContractDataSet/train_data_formatted_graph/25196.sol"  # 具体的文件路径
    ...
    inputFileDir = "../SmartContractDataSet/train_data_formatted_graph/"
